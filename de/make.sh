...
# Variables
filename="lernOS-Biases-de"
chapters="./src/index.md ./src/1-0-Grundlagen.md ./src/2-00-Lernpfad.md ./src/2-01-was-bringt-dich-hierher.md ./src/2-12-retrospektive.md ./src/3-0-Anhang.md"
